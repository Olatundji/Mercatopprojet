...
import CreateCategoriePromotion from '@/views/dashboard/pages/CreateCategoriePromotion.vue'
import CreateMontantPromotion from '@/views/dashboard/pages/CreateMontantPromotion.vue'
...
const routes = [
  {
    ...
    children: [
      ...
      meta: {requireAuth: true, type:'admin'},
        component: CreateCategoriePromotion
      },

      {
        path: "/admin/promotion-montant",
       name: 'CreateMontantPromotion',
      meta: {requireAuth: true, type:'admin'},
        component: CreateMontantPromotion
      },
