                        ...
                        <div id='carousel-custom' class='carousel slide' data-ride='carousel'>
                            ...
                            <ol class='carousel-indicators mCustomScrollbar meartlab'>
                                ...
                                <li data-target='#carousel-custom' data-slide-to='6'>
                                    <img src='@/assets/images/shop/single-products/product-7.jpg' alt='' />
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <ul class="media-list comments-list m-bot-50 clearlist">
                                        ...
                                        <li class="media">
                                            ...
                                            <a class="pull-left" href="#!">
                                                <img class="media-object comment-avatar" src="@/assets/images/blog/avater-1.jpg"
                                        ...
                                        <li class="media">
                                            ...
                                            <a class="pull-left" href="#!">
                                                <img class="media-object comment-avatar" src="@/assets/images/blog/avater-4.jpg"
                                                    alt="" width="50" height="50" />
                                            </a>
